...
params = {
    'save_path': '/content/drive/Shareddrives/Alan/TDriveAIO',
...
def make_reply(msg):
    ...
    if result:
        ...
        print(datetime.datetime.now())
        reply='Download Finished You can find downloaded file @ https://drive.google.com/folderview?id=1wgGbYxDbThRKUGpWPJ3FW8g--6o75TQF'
